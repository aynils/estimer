    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valeur_fonciere', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ...
                ('lot1_surface_carrez', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('lot2_numero', models.CharField(max_length=255, null=True)),
                ('lot2_surface_carrez', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('lot3_numero', models.CharField(max_length=255, null=True)),
                ('lot3_surface_carrez', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('lot4_numero', models.CharField(max_length=255, null=True)),
                ('lot4_surface_carrez', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('lot5_numero', models.CharField(max_length=255, null=True)),
                ('lot5_surface_carrez', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ...
                ('surface_reelle_bati', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ...
                ('surface_terrain', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('longitude', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('latitude', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('section_prefixe', models.CharField(max_length=5, null=True)),
            ],
        ),
        migrations.AddIndex(
            model_name='valeursfoncieres',
            index=models.Index(fields=['date_mutation', 'code_commune', 'type_local'], name='dvf_valeurs_date_mu_c781de_idx'),
        ),
    ]
